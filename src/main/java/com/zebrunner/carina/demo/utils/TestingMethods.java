...
public class TestingMethods implements IAbstractTest{
    private static final Logger logger = LoggerFactory.getLogger(TestingMethods.class);
...
//                .until(ExpectedConditions.visibilityOf(cartPage.getProductPriceInTheCartElement()));
    ...
    public List<String> loginAndAddProductToCart(WebDriver driver, String username, int productIndex) {
        ...
        testingMethods.login(driver, username, R.CONFIG.get("passwordGlobal"));
        return testingMethods.addProductToCartByIndex(driver, productIndex);
    }
    ...
    public void waitForProductsOnMainPage (WebDriver driver, AllProductsPageBase allProductsPage) {
    ...
    public void waitForProductsOnCartPage (WebDriver driver, CartPageBase cartPage) {
    ...
    public Pair<List<String>, List<String>> addMultipleProductsToCart(WebDriver driver, List<Integer> indexes, AllProductsPageBase allProductsPage, int size) {
    ...
    public void validateCartContents(CartPageBase cartPage, List<String> selectedProductNames, List<String> cartProductNames, List<String> selectedProductPrices, List<String> cartProductPrices) {
    ...
    public void validateTotalPrice(CartPageBase cartPage, List<String> expectedPrices, String totalPrice) {
